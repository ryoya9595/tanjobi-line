...
> お客様の誕生日を**LINEで登録して、当日の朝にLINEで受け取る**仕組みを作ります。
> 鑑定のあとに「山田花子 1990/06/23 転職相談」とLINEに送るだけで台帳に入り、その方の誕生日の朝に、同じトーク画面へ年齢と前回のメモつきで届きます。
>
...
山田 花子,1990-06-23,2026-07-12,転職と人間関係
```
...
> 「導入できました。
>
> **登録**：鑑定のあとに、LINEで `山田花子 1990/06/23 転職相談` のように送ってください。
> **更新**：次に来られたときは `メモ 山田花子 今回の相談内容` と送ると、前回の鑑定日が今日になります。
